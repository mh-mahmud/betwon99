                ...
                <form action="" method="post" accept-charset="utf-8" class="validate_form" novalidate="novalidate">
                    ...
                    <div class="grid_16">
                        ...
                        <div class="col_20" style="margin-top:10px; margin-bottom: 10px;">
                            <input type="text" value="1 run" name="answers[]">
                            <input type="text" value="1.2" class="col_160" name="ratios[]">
                        </div>
                        <div class="col_20" style="margin-top:10px; margin-bottom: 10px;">
                            <input type="text" value="2 run" name="answers[]">
                            <input type="text" value="3.5" class="col_160" name="ratios[]">
                        </div>
                        <div class="col_20" style="margin-top:10px; margin-bottom: 10px;">
                            <input type="text" value="3 run" name="answers[]">
                            <input type="text" value="2.2" class="col_160" name="ratios[]">
                        </div>
                        <div class="col_20" style="margin-top:10px; margin-bottom: 10px;">
                            <input type="text" value="4 run" name="answers[]">
                            <input type="text" value="5.3" class="col_160" name="ratios[]">
                        </div>
