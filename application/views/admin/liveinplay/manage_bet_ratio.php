                    ...
                    <div class="col-md-12">
                        ...
                        <div class="portlet box yellow">
                            <div class="portlet-title portlet-box">
                                <div class="caption">Live Matches </div>
                                <div class="tools">
                                ...
                                <div class="panel-group accordion" id="accordion1">
                                    ...
                                    <div id="panel-data-<?php echo $val->id; ?>" class="panel panel-default">
                                        ...
                                        <div class="custom-panel">
                                            <div style="" class="accordion-toggle" data-toggle="collapse" data-parent="#accordion1" href="#collapse_<?= $i; ?>">
                                                ...
                                                <select style="margin-left:10px" onchange="return updateMatchStatus(<?= $val->id ?>, this.value)" class="select_match_status" name="match_status">
                                                ...
                                                <input style="width: 280px;margin-left:10px;color:#333;" onfocusout="return updateBetScore(<?= $val->id ?>, this.value)" autocomplete="off" placeholder="score...." name="notification" type="text" value="<?= $val->notification; ?>">
                                        ...
                                        <?php
                                            $get_bet_data = $this->db->query("SELECT * FROM match_option WHERE match_id='{$val->id}' AND status IN(0,1) ORDER BY match_option_serial ASC")->result();
                                        ...
                                        <div class="panel panel-default set-win-<?= $data->id; ?>" style="margin:5px;font-size:12px">
                                            <div class="panel-heading" style="padding:5px">
                                                ...
                                                <span>
                                                    <?php
                                                        $tot_bet = $this->db->query("SELECT SUM(`bet_coin`) AS total_bet FROM matchbit_coin WHERE match_bet_option_id='{$data->id}'")->row();
                                                    ?>
                                                    ...
                                                    &nbsp;&nbsp;&nbsp;
                                                    <input type="text" placeholder="Note...." class="unifrom qnote" style="width: 400px;border:1px solid #555" value="">
                                                </span>
                                            </div>
                                            ...
                                            <div class="panel-body">
                                                ...
                                                <div class=" row option-data col-md-3 col-sm-3 col-xs-6" style="margin-bottom:10px;text-align:center;margin-left:10px">
                                                        ...
                                                        <?php
                                                            ...
                                                            // $BAD = $this->db->query("SELECT SUM(bet_coin) AS tb, FROM matchbit_coin WHERE match_bit_id='{$id}' GROUP BY bet_coin")->row();
                                                        ?>
                                                        <strong>
                                                        <span id="tb-tr-<?= $id ?>">
                                                            TB: <?php //!empty($BAD->tb) ? $BAD->tb : 0; ?>
                                                            TR: <?php //!empty($BAD->tb) ? $BAD->tb*$op->option_coin : 0; ?>
                                                        </span>
                                                        </strong>
                            ...
                            <div class="portlet-body">
                                <div class="panel-group accordion" id="accordion3">
                                    ...
                                    <div class="panel panel-default">
                                        ...
                                        <div class="custom-panel">
                                            <div class="accordion-toggle" data-toggle="collapse" data-parent="#accordion3" href="#collapse_<?= $j; ?>">
                                        ...
                                        <!-- <div id="collapse_<?php //echo $j; ?>" class="panel-collapse <?php //echo $j==101 ? "in" : "collapse";  ?>"> -->
                                        <div id="collapse_<?= $j; ?>" class="panel-collapse <?= $j==101 ? "collapse" : "collapse";  ?>">
...
<script>
    ...
    function updateMatchStatus(match_id, active_status) {
        ...
        if(active_status==6) {
            x = confirm("Are you sure to disable this match?");
            if(x==false) {
                return;
            }
        }
