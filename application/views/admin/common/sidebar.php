                ...
                <div class="page-sidebar navbar-collapse collapse">
                    ...
                    <ul class="page-sidebar-menu" data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200">
                        ...
                        <?php if($this->session->userdata('admin_access_data')->role_data=='super_admin') : ?>
                            <li class="nav-item <?php echo menu_top_route(['settings', 'notice-panel', 'bet_question', 'manage_league', 'admin_user', 'manage_role', 'customer_withdraw', 'deposit_account', 'customer_balance_transfer']); ?>">
                                <a href="javascript:;" class="nav-link nav-toggle">
