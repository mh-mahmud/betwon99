    ...
    <div id="loginRegister" class="row mr-auto justify-content-center">
        <nav class="navbar navbar-expand-md navbar-light col-xl-10 pr-0">
            ...
            <a id="neymar-box" class="navbar-brand hm-HeaderModule_Logo" href="<?= base_url(); ?>view_profile">
                <img id="neymar-logo" src="<?= base_url(); ?>assets/images/neymar.jpg" class=" z-depth-0" alt="avatar image" height="35">
        ...
        <div class="header-buttons" style="border:1px solid red;width:100%;margin-left:70px;padding:0px;margin-bottom:5px;background-color:#F93154">
            ...
            <span class="pull-right" style="padding-right:3px">
                <strong> user : <span class="user_balance" style="color:#FFF;"><?= $username ?></span></strong>
            </span>
        </div>
