...
<?php if(!empty($get_data)) : ?>
    ...
    <?php foreach($get_data as $val) : $match_id = $val->id; ?>
        <div class="card-header bg-white col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12 p-0">
            ...
            <div id="match-data-<?php echo $match_id; ?>"
                 class="collapse show m-0 p-0 col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="m-0 p-0 col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="bg-black-real score_div container m-0 pt-5 pb-10 p-15 col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="text-khet-yellow">
                            <b>
                                <?php if($val->sportscategory_id==6) : ?>
                                    <img src="<?php echo base_url(); ?>/assets/img/football.gif" class="img-thumbnail bg-transparent border-0 img_icon icon_small">&nbsp;&nbsp; <?php echo $val->notification; ?> &nbsp;&nbsp;
                                    <img src="<?php echo base_url(); ?>/assets/img/football.gif" class="img-thumbnail bg-transparent border-0 img_icon icon_small">
                                <?php elseif($val->sportscategory_id==2) : ?>
                                    <img src="<?php echo base_url(); ?>/assets/img/mv2.gif" class="img-thumbnail bg-transparent border-0 img_icon icon_small">&nbsp;&nbsp; <?php echo $val->notification; ?> &nbsp;&nbsp;
                                    <img src="<?php echo base_url(); ?>/assets/img/mv2.gif" class="img-thumbnail bg-transparent border-0 img_icon icon_small">
                                <?php endif; ?>
                            </b>
                        </div>
                    </div>
                    ...
                    <div class="bg-white container m-0 col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12 odd-sport-row">
                        <div class="row">
                            <div data-match-id="<?php echo $match_id; ?>" id="question-title-<?php echo $i; ?>" aria-expanded="false" role="button" class="cream-color capitalize col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12 m-0 under-red cursor-pointer collapseBtnAnswers clearfix">
                                <strong><?php echo $data->match_option_title; ?>&nbsp;&nbsp;<i class="live-badge">In Play</i></strong>
                            </div>
                            <div id="question-data-<?php echo $i; ?>" class="capitalize col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12 under-red clearfix soft-color">
                                    ...
                                    <?php foreach($options as $op) : ?>
										<li class="list-inline-item cursor-pointer  col-sm-6">
											...
											<div onclick='return showBetModal("<?php echo $op->option_coin; ?>", "<?php echo $op->id; ?>");' class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12 bg-white-custom text-center text-dark fixed-width-120">
												<strong><?php echo $op->option_coin; ?></strong>
											</div>
										</li>
									<?php endforeach; ?>
...
<?php else: ?>
    ...
    <div class="card-header bg-white col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12 p-0">
        <div id="match-title" aria-expanded="false" role="button" class="collapseBtnMatchTitle card-body text-white row capitalize col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12 pt-5 pb-5 pl-0 pr-0 ml-0" style="background-color:#CC0000;padding:10px !important">
            <div class="col-xl-11 col-lg-11 col-md-11 col-sm-11 col-xs-11">
